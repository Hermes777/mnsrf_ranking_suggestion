        ...
        with open(path, 'r') as f:
            ...
            for line in f:
                ...
                if line:
                    ...
                    if current_session:
                        if self.max_session_length < len(current_session):
                            self.max_session_length = len(current_session)
                        for query in current_session:
                        ...
                        if len(current_session) in samples:
                            samples[len(current_session)].append(current_session)
                        else:
                            samples[len(current_session)] = [current_session]
                        current_session = []
        return samples
