...
class Train:
    ...
    def train(self, train_corpus):
        ...
        for batch_no in range(1, num_batches + 1):
            ...
            train_sessions, length, train_clicks, click_labels = helper.session_to_tensor(train_batches[batch_no - 1],
                                                                                          self.dictionary)
            if self.config.cuda:
            ...
            loss = self.model(train_sessions, length, train_clicks, click_labels)
    ...
    def validate(self, dev_corpus):
        ...
        for batch_no in range(1, num_batches + 1):
            dev_sessions, length, dev_clicks, click_labels = helper.session_to_tensor(dev_batches[batch_no - 1],
                                                                                      self.dictionary)
            if self.config.cuda:
