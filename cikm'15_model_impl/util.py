...
def get_args():
    ...
    parser.add_argument('--dev_every', type=int, default=15000,
                        help='development report interval')
    parser.add_argument('--save_every', type=int, default=15000,
                        help='saving model interval')
    parser.add_argument('--resume', default='', type=str, metavar='PATH',
                        help='resume from last checkpoint (default: none)')
    parser.add_argument('--save_path', type=str, default='../output_session/',
